<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ModifyChildMenu.aspx.cs"
    Inherits="ProductInventoryManagement.Menu.ModifyChildMenu" %>
        ...
        <div class="row">
            <div class="col-lg-12" style="padding-left: 0px; padding-right: 0px;">
                <ol class="breadcrumb" style="margin: 0px; padding-left: 15px;">
                    <li>当前位置：</li>
                    <li>系统设置</li>
                    <li><a href="MenuPageList.aspx?pId=<%=pid%>&&MenuName=<%=pname %>">页面列表</a></li>
                    <li>页面修改</li>
                </ol>
            </div>
        </div>
