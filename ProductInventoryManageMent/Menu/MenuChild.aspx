<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MenuChild.aspx.cs" Inherits="ProductInventoryManagement.Menu.WebForm1" %>
                    ...
                    <asp:Repeater runat="server" ID="rpt_MenuBlock">
                        <ItemTemplate>
                            <tr <%# Eval("IsInUse").ToString() == "1" ? "" : "style='color:#999;'"%>>
                                ...
                                <td style="padding: 2px;">
                                    <%# Eval("IsInUse").ToString() == "1" ? "<b>是</b>" : "<b style=\"color:#999;text-decoration-line:line-through;text-decoration-color:red;text-decoration-style:solid\">否</b>"%>
                                </td>
                                <td style="padding: 2px;">
                                    <%#Eval("Sequence")%>
                                </td>
                                <td style="padding: 2px;">
                                    <a href="ModifyChildMenu.aspx?pname=<%=parentMenuName%>&&ID=<%#Eval("ID")%>&&pId=<%=parentid %>"
                                        class="btn btn-primary btn-xs">修改</a> &nbsp;<input type="button" class="btn btn-primary btn-xs"
                                            onclick="DelChild(<%#Eval("ID")%>)" value="删除" />
                                </td>
                            </tr>
                        </ItemTemplate>
                    </asp:Repeater>
