<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditRole.aspx.cs" Inherits="ProductInventoryManagement.Role.EditRole" %>
    ...
    <div class="container" style="width: 100%;">
                        ...
                        <ItemTemplate>
                            <tr>
                                <td align="right" style="width: 15%;">
                                    <asp:CheckBox runat="server" ID="parentId" Text='<%#Eval("MenuName") %>' value='<%#Eval("ID") %>'
                                        onclick="CheckChange(this);" />
                                </td>
                                <td align="left" style="font-size: 12px;">
                                    <asp:CheckBoxList runat="server" ID="cbList" RepeatDirection="Horizontal" RepeatLayout="Flow"
                                        onclick="aaa(this);">
                                    </asp:CheckBoxList>
                                </td>
                            </tr>
        ...
        <div class="form-group" style="text-align: center">
            <div class="col-sm-offset-4 col-sm-4">
                <asp:Button ID="btnSave" runat="server" Text="修改" CssClass="btn btn-primary" OnClick="btnSave_Click"
