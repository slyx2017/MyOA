<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ModifyDept.aspx.cs" Inherits="ProductInventoryManageMent.Sys.ModifyDept" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function formSend() {
            ...
            $.ajax({
                type: "post",
                url: "../ashx/dept.ashx?param=modify",
                dataType: "text",
                data: "ID=" + id + "&&DeptTypeName=" + depttype + "&&orderNum=" + orderNum + "",
            ...
            <div class="form-group" style="text-align: center">
                ...
                <div class="col-sm-4">
                    <input type="text" class="form-control" name="DeptTypeName" id="DeptTypeName" required="required"
                        placeholder="部门类别" value="<%=model.DeptName %>" />
                </div>
            </div>
            <div class="form-group" style="text-align: center">
                <label for="orderNum" class="col-sm-4 control-label">
                    排序数值</label>
                <div class="col-sm-4">
                    <input type="number" class="form-control" name="orderNum" id="orderNum" required="required" value="<%=model.SortNum %>" />
                </div>
            </div>
            <div class="form-group" style="text-align: center">
