<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ModifyAlbum.aspx.cs" Inherits="ProductInventoryManagement.Album.ModifyAlbum" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function formSend() {
            ...
            $.ajax({
                type: "post",
                url: "../ashx/album.ashx?param=editalbum",
                dataType: "text",
                data: "AlbumId=" + <%=albumid%> + "&&AlbumName=" + albumname + "&&AlbumTypeID=" + albumtypeid + "&&AlbumDesc=" + albumdesc + "",
