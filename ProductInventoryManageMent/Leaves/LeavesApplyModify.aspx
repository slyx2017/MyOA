<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LeavesApplyModify.aspx.cs" Inherits="ProductInventoryManageMent.Leaves.LeavesApplyModify" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function formSend() {
            ...
            var data = "Id=" + Id + "&&LeaveReason=" + LeaveReason + "&&BeginTime=" + BeginTime + "&&EndTime=" + EndTime + "&&LeaveType=" + LeaveType + "&&ApprovalPerson=" + ApprovalPerson + "";
            $.ajax({
                type: "post",
                url: "../ashx/leave.ashx?param=modify",
                dataType: "text",
                data: data,
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <input type="text" class="form-control" name="LeaveReason" id="LeaveReason" required="required"
                        placeholder="请假原因" value="<%=model_leave.LeaveReason %>" />
                </div>
                <div class="col-sm-2"></div>
                <div class="col-sm-2"></div>
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <input type="text" class="form-control" name="ApprovalPerson" id="ApprovalPerson"
                        required="required" placeholder="审批人"  value="<%=model_leave.ApprovalPerson %>" />
                </div>
                <div class="col-sm-2"></div>
                <div class="col-sm-2"></div>
